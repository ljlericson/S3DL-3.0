...
namespace Core
{
    namespace OpenGlBackend
    {
        ...
        Texture::Texture(const aiTexture* tex, GLuint texUnit, const std::string& texSrc)
        ...
        void Texture::setParam(GLuint pname, GLuint params)
        {
        ...
        void Texture::uniform(GLuint shadProgram, const char* uName) const
        {
